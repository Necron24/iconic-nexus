...
type Person = {
  ...
  published_projects?: number; approved_tests_received?: number; average_rating?: number | null; devlog_count?: number;
...
export default async function WallOfFamePage() {
  ...
  const { data, error } = await supabase.rpc("wall_of_fame_v2", { p_limit: 10 });
